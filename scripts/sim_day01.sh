...
DIR_DAY_N='day01'                    # folder name
FILENAME_RTL_TOP='mux'              # file name rtl top module
FILENAME_TB_TOP='tb_mux'            # file name tb top
FILENAME_VVP='mux'                  # file name output vvp
FILENAME_SYNTH='day01_synth'         # file name yosys sim script
FILENAME_NETLIST='netlist_mux'      # file name yosys generated netlist
