...
DIR_DAY_N='day09'                               # folder name
FILENAME_RTL_TOP='top_encoder'                  # file name rtl top module
FILENAME_TB_TOP='tb_gray_bin_encoders'          # file name tb top
FILENAME_VVP='gray_bin_encoders'                # file name output vvp
FILENAME_SYNTH='day09_synth'                    # file name yosys sim script
FILENAME_NETLIST='netlist_gray_bin_encoders'    # file name yosys generated netlist
