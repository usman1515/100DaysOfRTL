...
DIR_DAY_N='day07'                    # folder name
FILENAME_RTL_TOP='lfsr'             # file name rtl top module
FILENAME_TB_TOP='tb_lfsr'           # file name tb top
FILENAME_VVP='lfsr'                 # file name output vvp
FILENAME_SYNTH='day07_synth'         # file name yosys sim script
FILENAME_NETLIST='netlist_lfsr'     # file name yosys generated netlist
