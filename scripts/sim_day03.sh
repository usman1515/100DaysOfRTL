...
DIR_DAY_N='day03'                            # folder name
FILENAME_RTL_TOP='edge_detector'            # file name rtl top module
FILENAME_TB_TOP='tb_edge_detector'          # file name tb top
FILENAME_VVP='edge_detector'                # file name output vvp
FILENAME_SYNTH='day03_synth'                 # file name yosys sim script
FILENAME_NETLIST='netlist_edge_detector'    # file name yosys generated netlist
