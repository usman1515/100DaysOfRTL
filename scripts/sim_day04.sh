...
DIR_DAY_N='day04'                    # folder name
FILENAME_RTL_TOP='alu'              # file name rtl top module
FILENAME_TB_TOP='tb_alu'            # file name tb top
FILENAME_VVP='alu'                  # file name output vvp
FILENAME_SYNTH='day04_synth'         # file name yosys sim script
FILENAME_NETLIST='netlist_alu'      # file name yosys generated netlist
