...
DIR_DAY_N='day02'                    # folder name
FILENAME_RTL_TOP='dff'              # file name rtl top module
FILENAME_TB_TOP='tb_dff'            # file name tb top
FILENAME_VVP='dff'                  # file name output vvp
FILENAME_SYNTH='day02_synth'         # file name yosys sim script
FILENAME_NETLIST='netlist_dff'      # file name yosys generated netlist
