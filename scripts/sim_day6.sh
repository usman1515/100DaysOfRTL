...
DIR_DAY_N='day6'                        # folder name
FILENAME_RTL_TOP='shift_reg'            # file name rtl top module 
FILENAME_TB_TOP='tb_shift_reg'          # file name tb top 
FILENAME_VVP='shift_reg'                # file name output vvp 
FILENAME_SYNTH='day6_synth'             # file name yosys sim script
FILENAME_NETLIST='netlist_shift_reg'    # file name yosys generated netlist
